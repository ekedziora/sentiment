...
for category in corpus.categories():
    for fileid in corpus.fileids(category):
        ...
        features.update(sentiwordnetSentimentWordsPresenceFeatures(wordsTagged))
        features.update(mpqaSubjectivityPresenceFeatures(wordsTagged, mpqaDictionary))
        features.update(posTagsPresenceFeatrues(wordsTagged))
        features.update(mpqaObjectivityWordsPresenceFeatures(wordsTagged, mpqaDictionary))
